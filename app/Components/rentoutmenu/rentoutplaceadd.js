...
export default function Rplaceadd({ navigation }) {
  ...
  const [modelarray, setmodelarray] = useState(["select Make first"])
  ...
  const modelarrayF = async (item) => {
    ...
    fetch(link + '/car/getModelsByMake?make=' + item, requestOptions)
      .then(response => response.json())
      .then(response => {
        console.log("dcdrc", response.result.length)
    ...
    <Fragment>
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Header text='RENTOUT MENU' back={() => navigation.goBack()} />
          ...
          <ScrollView
            ...
            <TouchableHighlight
              ...
              style={{
                height: height(7), width: width(85),
                marginTop: height(2), alignSelf: 'center', borderWidth: 1, borderRadius: 10, flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center'
              }}
            >
            ...
            >
              ...
              <View
                style={{ height: height(5), width: width(60), borderWidth: 1, borderColor: '#931a25', borderRadius: 5, flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center' }}
              >
            ...
            <View style={{ width: width(95), alignSelf: 'center' }}>
              ...
              <View style={{ height: height(12), alignItems: 'center', flexDirection: 'row' }}>
                ...
                <TextInput
                  ...
                  multiline
                  style={{
                    paddingVertical: 0, width: width(70),
                    fontSize: totalSize(3.5), fontFamily: 'BebasNeue-Regular',
                    borderBottomWidth: 1, borderBottomColor: '#a2a2a2'
                  }}
                />
            ...
            <View style={styles.Boldtextview}>
              ...
              <ModalDropdown
                ...
                options={['Coupe', 'Converted', 'saloon', 'hatchback', 'estate', 'mvp', 'minibus', 'suv', 'van', 'unlisted']}>
              ...
              <View style={{
                ...
                <View style={{
                  ...
                  <ModalDropdown
                    ...
                    <View
                      style={{ width: 40, flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center' }}>
                ...
                <View style={{
                  width: width(20), marginRight: width(1), borderWidth: 1,
                  height: height(5)
                }}>
                  ...
                  <TextInput
                    ...
                    style={{ fontSize: totalSize(3), paddingVertical: 0, fontFamily: 'BebasNeue-Regular' }}
                  />
            ...
            <View style={styles.Boldtextview}>
              ...
              <View style={{
                width: width(35), flexDirection: 'row', alignItems: 'center',
                justifyContent: 'space-between',
            ...
            >
              <View style={{
                ...
                <View style={{
                  height: height(20), width: width(50), backgroundColor: '#fff', borderRadius: 10,
          ...
          >
            <View style={{ height: height(100), backgroundColor: '#fff' }}>
              ...
              <View style={{ width: width(95), marginTop: height(4), alignSelf: 'center', }}>
                ...
                <Text style={{
                  fontSize: totalSize(2.2), width: width(90), alignSelf: 'center',
                  color: '#b8b8b8', fontFamily: 'BebasNeue-Regular'
                }}>
