...
export default function Reditadd({ navigation, route }) {
  ...
  const [scale, setscale] = useState(width(35))
  const map = useRef()
  useEffect(() => {
          ...
          <ScrollView
            ...
            <TouchableHighlight
              ...
              style={{
                ...
                shadowRadius: 1.41,
                alignSelf: 'center',
                elevation: 5, width: width(70), marginTop: height(2), borderRadius: 5, backgroundColor: '#fff', flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center'
              }}
            >
            ...
            <View style={styles.Boldtextview}>
              ...
              <ModalDropdown
                ...
                options={[
                  'unlisted', 'Aquamarine', 'Aqua', 'Blue', 'Black', 'Brown', 'Cyan', 'Gold', 'Green', 'Gray',
            ...
            <View style={styles.Boldtextview}>
              ...
              <View style={{
                height: height(5), width: width(33), flexDirection: 'row',
                ...
                <View style={{
                  ...
                  <ModalDropdown
                    ...
                    <View
                      ...
                      <MaterialIcons name='arrow-drop-down' size={22} color='#868887'
                        style={{
                          // borderWidth: 1,
                          alignSelf: 'center',
                          width: 18
                ...
                <View style={{ width: width(20), borderWidth: 1 }}>
            ...
            <View style={styles.Boldtextview}>
              ...
              <View style={{ height: height(5), width: width(30), flexDirection: 'row', borderWidth: 1, alignItems: 'center' }}>

                <View style={{ width: width(19), marginRight: width(1) }}>
